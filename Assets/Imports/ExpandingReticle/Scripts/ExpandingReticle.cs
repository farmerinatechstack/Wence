...
public class ExpandingReticle : MonoBehaviour {
	...
	// Distances of the reticle (meters).
	private const float kReticleDistanceMin = 0.45f;
	private const float kReticleDistanceMax = 10.0f;

	// Current diameters of the reticle, before distance multiplication.
	...
	// Called externally to set the reticle position
  	public void SetGazeTarget(Vector3 target, bool interactive) {
